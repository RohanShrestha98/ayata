...
export default function Summary() {
    return (
        <div className='px-32 xl:px-24 lg:px-16 ml:px-10 sm:px-4 py-10 flex flex-col gap-[120px]'>
            <div className='flex gap-24'>
                <div className='flex flex-col gap-10 w-[60%]'>
                    <p className='text-5xl font-medium text-[#293056]'>Project Summary</p>
                    <p className='text-[#667085] leading-10'>
            ...
            <div className='flex flex-col gap-10 '>
                <p className='text-5xl text-[#293056] leading-[57.6px] text-center'>Get insights on various other projects successfully delivered by Ayata</p>
